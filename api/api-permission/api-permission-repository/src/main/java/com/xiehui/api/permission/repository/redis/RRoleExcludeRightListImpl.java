 ...
 *
 */
@Repository("rRoleExcludeRightList")
public class RRoleExcludeRightListImpl implements RRoleExcludeRightList {
	...
	/** 键值格式 */
	private static final MessageFormat KEY_FORMAT = new MessageFormat("API:List:RRoleExcludeRightList:{0}");
