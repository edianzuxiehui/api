			...
			$('#idRptPlancomp').datagrid({
				...
				toolbar:[{
					...
					handler:function(){
						...
						var queryInfo="{'planCode':'"+plancode+"','regentirId':'"+$("#idRegEntireId").val()+"','beginDate':'"+beginDate+"','endDate':'"+time+"'}";
				...
				columns:[[
			{title:' ',field:'DESC',align:'center',width:200,sortable:true},	
			{title:'计划代码',field:'PLAN_CODE',align:'center',width:100,sortable:true},
			{title:'计划名称',field:'PLAN_NAME',align:'center',width:100,sortable:true},
			{title:'任务总数',field:'ALLCOUNT',align:'center',width:100,sortable:true},
			{title:'已完成的',field:'COMPLET',align:'center',width:100,sortable:true},
			{title:'未完成',field:'UNCOMPLET',align:'center',width:100,sortable:true},
			{title:'执行率',field:'RATE',align:'center',width:100,sortable:true}
				]]
			});
