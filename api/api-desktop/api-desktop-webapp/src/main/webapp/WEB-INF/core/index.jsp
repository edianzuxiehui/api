...
<script type="text/javascript">
	...
	function addOperInfo() {
		...
		var param = "tmsModuleTitle="
				+ escape(escape($('#idTmsModuleTitle').val()))
				+ "&tmsModuleId=" + escape(escape($('#idTmsModuleId').val()));
		$('#ff').form('submit', {
...
<body class="easyui-layout" fit="true" id="bdLayout">
	...
	<div region="north" style="height: 80px; border: 0px">
		<div class="easyui-layout" fit="true">
			<div region="center" border="false"
				style="background: url('<%=basePath%>images/logo_bg5_1.png')">
				<div
					style="height:100%;width:100%;BACKGROUND: url('<%=basePath%>images/logo_bg5.gif') no-repeat"></div>
			</div>
				...
				<div class="easyui-layout" fit="true">
					<div region="center" border="false">
						...
						<div class="menu_navcc">
							<div class="clearfix"
								style="height:100%;width:100%;background:url('<%=basePath%>images/index/nav_bg.gif') repeat-x">
								<table>
	...
	<div region="south" id="tenp" border="false"
	...
	<div id="mainPanle" region="center"
		style="background: #eee; overflow: hidden:hidden; border: 0px">
		<div class="easyui-layout" fit="true">
			<div region="center"
				style="position:relative;background:url('<%=basePath%>images/indexbg.png') repeat;border:0px">
				<div id="tabs" class="easyui-tabs" fit="true" border="false">
					<div title="欢迎使用"
						style="padding: 0px; overflow: hidden; background: #f0ebf2; text-align: center">
					</div>
				</div>
			</div>
		</div>
	...
	<div id="test" class="easyui-window" closed="true" modal="true"
		title="修改密码" draggable="false" inline="true" maximizable=false
				...
				<form id="ff" method="post">
					<table class="formTable" style="width: 95%;">
						...
						<tr>
							...
							<td><input type="hidden" id="focus" /> <input
								type="password" class="easyui-validatebox" validType="safepass"
								required="true" name="OLDPWD" id="oldpwd" maxlength="20" /></td>
						</tr>
						<tr>
							<td><div style="text-align: right;">
							...
							<td><input type="password" class="easyui-validatebox"
								validType="safepass" required="true" name="NEWPWD" id="newpwd"
								maxlength="20" /></td>
						</tr>
						<tr>
							<td><div style="text-align: right;">
						...
						<tr>
							<td colspan="2">
								<div style="text-align: center; padding-top: 10px">
									&nbsp;&nbsp;&nbsp;&nbsp; <input id="idQuery" type="button"
										class="btn_grid" value="  确   认  " onclick="addOperInfo();" />
									<input id="idReset" type="button" class="btn_grid"
										value="  重  置  " onclick="cleardata();" /> <input
										id="idReset" type="button" class="btn_grid" value="  关  闭   "
										onclick="closeWin();" />
								</div>
							</td>
						</tr>
	...
	<%
		if (request.getAttribute("menuList") == null || ((List) request.getAttribute("menuList")).size() == 0) {
	%>
	<script type="text/javascript">
