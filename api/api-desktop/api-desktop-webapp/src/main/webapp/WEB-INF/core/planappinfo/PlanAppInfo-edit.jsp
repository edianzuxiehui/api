  ...
  <base target="_self">
	...
	<script type="text/javascript" src="<%=basePath%>js/easyui-lang-zh_CN.js"></script>
		...
		<script type="text/javascript">
		  ...
		  if(k.par){
		  	var param=k.par;
			$.getJSON("queryPlanAppInfo.do",param,function(data){
...
<body class="easyui-layout" fit="true">
				...
				<col width="250px" >
							...
							<tr>
								<td>计划编号</td>
								<td>
									<input type="text" class="easyui-validatebox" required="true"   name="PLAN_CODE" id="idPlanCode" maxlength="8" />
								</td>
							</tr>
							<tr>
								<td>应用编号</td>
								<td>
									<input type="text" class="easyui-validatebox" required="true"   name="APP_ID" id="idAppId" maxlength="8" />
								</td>
							</tr>
							<tr>
								<td>应用版本</td>
							...
							<tr>
								<td>更新时间</td>
								<td>
									<input type="text" class="easyui-validatebox"    name="UPDATE_DATE" id="idUpdateDate" maxlength="19" />
								</td>
							</tr>
							<tr>
								<td>应用更新标志</td>
					...
					<div region="south"   style="text-align:right;" class="toolbarHeader">
						<a class="easyui-linkbutton" iconCls="icon-ok" href="javascript:void(0)" onclick="addPlanAppInfo()">确认</a>
