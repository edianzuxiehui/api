	$(function(){
			...
			$('#idRptPlannocomp').datagrid({
				...
				toolbar:[{
					...
					handler:function(){
						...
						var queryInfo="{'planCode':'"+plancode+"','regentirId':'"+$("#idRegEntireId").val()+"','validDate':'"+time+"'}";
			...
			{title:'主应用商户号',field:'MERCHID',align:'center',width:100,sortable:true},
			...
			{title:'硬件系列号',field:'SERIAL_NO',align:'center',width:100,sortable:true},
			{title:'联系人',field:'CONNECTER',align:'center',width:100,sortable:true},
			{title:'联系电话',field:'OPER_CALLNO',align:'center',width:100,sortable:true}
				]]
			});
