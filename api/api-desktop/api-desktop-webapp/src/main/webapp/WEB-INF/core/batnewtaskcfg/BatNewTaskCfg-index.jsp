	...
	<script type="text/javascript">
		...
		function doEdit(){
		    ...
		    if(ids){
			     $.ajax({
					   type: "POST",
					   url: "isBatNewTaskCfgUpdateable.do",
					   data: ids,
				...
				<col width="7%" >
							<tr>
								...
								<td>
									...
									<input type="text" class="easyui-validatebox" style="background-color: #EEEEEE" readonly name="REG_NAME" id="idRegName" style="width:9em"/>
								...
								<td>执行状态</td>
								<td>
				                  <select name="RUN_STATUS" id="idRunStatus" style="width:9em">
								...
								<td>查询厂商</td>
								<td>
									<select  name="QUERY_FID" id="idFidSelect" maxlength="15" style="width:9em" onchange="changeModelByFID(this.value);">
			...
			<!-- 				<td>应用</td>
							...
							<tr>
								...
								<td>
									...
									<input type="text" class="easyui-validatebox" style="background-color: #EEEEEE" readonly name="Query_REG_NAME" id="idQueryRegName" style="width:9em"/>
								...
								<td>
				                  <select name="CHECK_STATUS" id="idCheckStatus" style="width:9em">
				                 	  <option value="" selected>全部</option>
								...
								<td>查询主机型号</td>
								<td>
									<select type="text" class="easyui-validatebox" name="QUERY_MID" id="idMidSelect" maxlength="20" style="width:9em">
