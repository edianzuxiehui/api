...
<head>
  ...
  <base target="_self">
	...
	<script type="text/javascript" src="<%=basePath%>js/common.js"></script>
		...
		$(function(){
			getSequence("CUSTOME_ID","idCustomeId");
		});
		 setModuleNameAndId();
		function cleardata(){
			$('#ff').form('clear');
		...
		function checkId(){
			var flag = checkPKIsExist("customeId",$('#idCustomeId').val(),"listCustomeInfoForPageCount");
			if(flag =="true"){
				msgShow("提示","您所输入的客服编号已经存在,请检查重新输入!!","error");
			}
...
<script language="javascript" type="text/javascript" src="<%=basePath%>js/DatePicker/WdatePicker.js"></script>
				...
				<col width="250px" >
							<tr>
								...
								<td>
									<input type="text" class="easyui-validatebox" required="true" validType="numberFixLength[8]"   name="CUSTOME_ID" id="idCustomeId" maxlength="8"  onchange="checkId();"/>
								</td>
							</tr>
							<tr>
