...
<head>
  ...
  <base target="_self">
	...
	<script type="text/javascript">
		...
		function queryInfo(){
		    ...
		    //var idParamGroup = $('#idParamGroup').combobox('getValue');//alert(idParamGroup);
		     var idParamGroup = document.getElementById("idParamGroup").value;//alert(idParamGroup);
	...
	function doImp(){//导入参数项文件
	  	var returnValue= openDialogFrame(getRootPath()+'/core/paramitem/importParamItem.jsp','',450,100);
		$('#idParamItem').datagrid('load');
 	 }	
	</script>
</head>
			...
			<form id="queryForm">
				...
				<col width="15%" >
							<tr>
								<td>参数组别</td>
								<td>
									<select id="idParamGroup"  name="PARAM_GROUP" style="width:120" panelHeight="auto">
								...
								<td>参数项编号</td>
								<td>
									<input type="text" name="PARAM_ID" id="idParamId" maxlength="8" style="width:9em"/>
								</td>
								<td>参数名称</td>
								<td>
									<input type="text" name="PARAM_NAME" id="idParamName" maxlength="40" style="width:9em"/>
								</td>
