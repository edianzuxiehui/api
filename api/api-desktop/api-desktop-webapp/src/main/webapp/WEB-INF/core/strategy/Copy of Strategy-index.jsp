	    ...
	    <div region="north" style="height: 75px;position:relative;" title=""  split="true">  
				...
				<col width="17%" >
							<tr>
								...
								<td>
				                  <select name="STRATEGY_TYPE" id="idStrategyType" style="width:145">
							...
							<tr>
								<td>状态</td>
								<td>
				                  <select name="STRA_STATUS" id="idStraStatus" style="width:145">
								...
								<td>报到间隔天数</td>
								<td>
									<input type="text" name="INTERVAL_DAYS" id="idIntervalDays" class="easyui-validatebox" validType="number" />
								</td>
								<td>备注</td>
								<td>
