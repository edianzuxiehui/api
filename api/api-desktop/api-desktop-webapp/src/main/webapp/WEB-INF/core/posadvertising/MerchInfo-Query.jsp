...
<head>
  <base href="<%=basePath%>">
    ...
    <script type="text/javascript" src="core/posadvertising/MerchInfoQuery-js.js"></script>
		...
		<div region="center"  >  
	     ...
	     <!--  
			<div id="toolbar" align="right">
				  <input type="button"  value="确定" class="btn_grid"  onclick="confirm();"  style="width:80; height:30"  />
				<input type="button" value="取消" class="btn_grid" onclick="window.close();"   style="width:80; height:30"/> 
