		...
		<script type="text/javascript">
		  ...
		  $.getJSON("queryMerchInfo.do",param,function(data){
		  	if(data.rows && data.rows.length==0) {
				msgShow('提示','商户不存在，请在商户资料管理中核查','info');
			}else{
...
<body class="easyui-layout" fit="true">
					...
					<table class="formTable" style="width:100%;">
						...
						<col width="10%" >
							<tr>
								...
								<td>商户名称</td>
								<td>
									<input type="text" class="easyui-validatebox"  validType="maxLen[80]" required="true"  name="MERCH_NAME" id="idMerchName" maxlength="80" />
								</td>
							...
							<!-- 
								...
								<td>商户MCC</td>
								<td>
									<input type="text" class="easyui-validatebox"  validType="maxLen[4]" name="MERCH_MCC" id="idMerchMcc" maxlength="4" />
								</td>
							</tr>
							<tr>
					...
					<div region="south"   style="text-align:right;" class="toolbarHeader">
						<a class="easyui-linkbutton" iconCls="icon-ok" href="javascript:void(0)" onclick="javascript:window.close();">关 闭</a>
					</div>
</body>
</html>
